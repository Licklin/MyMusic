...
public class MediaNotificationManager {
    ...
    public MediaNotificationManager(Application application){
        ...
        clickPendingIntent = PendingIntent.getActivity(application, 0,
                new Intent(application, SettingHomeActivity.class),
                PendingIntent.FLAG_IMMUTABLE);
        deletePendingIntent = getPendingIntent(application,
                BaseMusicService.MyMusic_CUSTOM_ACTION_STOP);

        mPlayAction =
                new NotificationCompat.Action(
                        R.drawable.iv_lrc_play,
                        application.getString(R.string.label_notification_play),
                        getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_PLAY));
        mPauseAction =
                new NotificationCompat.Action(
                        R.drawable.iv_lrc_pause,
                        application.getString(R.string.label_notification_pause),
                        getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_PAUSE));
        mNextAction =
                new NotificationCompat.Action(
                        R.drawable.iv_next,
                        application.getString(R.string.label_notification_next),
                        getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_NEXT));

        mPrevAction =
                new NotificationCompat.Action(
                        R.drawable.iv_previous,
                        application.getString(R.string.label_notification_previous),
                        getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_PREVIOUS));

        mLoveAction =
                new NotificationCompat.Action(
                        R.drawable.ic_love,
                        application.getString(R.string.label_notification_love),
                        getPendingIntent(application, BaseMusicService.MyMusic_CUSTOM_ACTION_COLLECT_SONGS));

        mOrderAction =
                new NotificationCompat.Action(
                        R.drawable.iv_playback_mode_order,
                        application.getString(R.string.label_notification_mode),
                        getPendingIntent(application, MediaPlayerManager.MyMusic_CUSTOM_ACTION_PLAYBACK_MODE_CHANGE));
        mRepeatAction =
                new NotificationCompat.Action(
        ...
        mLrcAction =
                new NotificationCompat.Action(
                        ...
                        getPendingIntent(application, BaseMusicService.MyMusic_CUSTOM_ACTION_SHOW_LYRICS));
...
//
    ...
    private void updateRemoteView(MediaMetadataCompat metadata,
        ...
        //播放
        PendingIntent playIntent = getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_PLAY),
                pauseIntent = getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_PAUSE);
        /*
...
//            viewBig.setImageViewBitmap(R.id.notification_iv_play,playBitmap);
    ...
    private void initRemote(Application application){
        ...
        //设置点击发送广播 大视图
        PendingIntent
                nextIntent = getPendingIntent(application, BaseMusicService.MyMusic_CUSTOM_ACTION_NEXT),
                previousIntent = getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_PREVIOUS),
                loveIntent = getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_COLLECT_SONGS),
                lrcIntent = getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_SHOW_LYRICS),
                stopIntent = getPendingIntent(application,BaseMusicService.MyMusic_CUSTOM_ACTION_STOP);
