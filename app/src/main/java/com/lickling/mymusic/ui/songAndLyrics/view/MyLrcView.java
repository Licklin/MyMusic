...
import com.lickling.mymusic.bean.lrcBean.LrcBean;
import com.lickling.mymusic.R;
import com.lickling.mymusic.ui.songAndLyrics.util.PictureUtil;
...
public class MyLrcView extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(LayoutInflater layoutInflater) {
        View view = layoutInflater.inflate(R.layout.my_lrc_view, this, true);
